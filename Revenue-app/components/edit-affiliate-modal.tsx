    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-card rounded-2xl shadow-xl animate-fadeIn">
        <div className="sticky top-0 bg-card flex items-center justify-between p-4 border-b border-border z-10">
          ...
          <button
            onClick={onClose}
            className="shrink-0 p-2 rounded-lg hover:bg-muted text-muted-foreground"
          >
            <X className="h-5 w-5" />
          </button>
        </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              {houses?.map((house) => (
                <div
                  key={house.id}
                  className="border border-border rounded-lg p-3 lg:p-4 space-y-3"
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 lg:gap-4 pl-0 sm:pl-8">
                    <div>
